                ...
                <div class="portfolio-item cat1 cat3">
                    <div class="portfolio-item-content">
                        ...
                        <div class="portfolio-description">
                            <h4><a href="albums/detay/<?php echo $album->id;?>" ><?php echo $album->title;?></a></h4>

                            <!-- Change the dummy image -->
                            <a href="uploads/<?php echo $album->image;?>" class="portfolio-gallery-set"><i class="fa fa-search-plus"></i></a><a href="albums/detay/<?php echo $album->id;?>"><i class="fa fa-link"></i></a>
                        </div>
                    </div>
                </div>
